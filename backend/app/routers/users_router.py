...
def update_profile(payload: UpdateProfileRequest, user_id: str = Header(default="u1", alias="x-user-id")):
...
def request_elevation(payload: RequestElevationRequest, user_id: str = Header(default="u1", alias="x-user-id")):
